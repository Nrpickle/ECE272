...
project -result_file {C:/lscc/diamond/3.1_x64/bin/nt64/Lab6_FinalDesign/section6_FinalDesign/section6_FinalDesign_section6_FinalDesign.edi}

#-- error message log file
project -log_file {section6_FinalDesign_section6_FinalDesign.srf}
