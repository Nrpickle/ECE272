...
set newDesign 0
if {![file exists "C:/lscc/diamond/3.1_x64/bin/nt64/Lab4_SmartTekbotRemote/Section4_sim/Section4_sim.adf"]} { 
	design create Section4_sim "C:/lscc/diamond/3.1_x64/bin/nt64/Lab4_SmartTekbotRemote"
  set newDesign 1
}
design open "C:/lscc/diamond/3.1_x64/bin/nt64/Lab4_SmartTekbotRemote/Section4_sim"
